...
export const Errors = {
  // 400
  BAD_REQUEST: (msg = 'Bad request') => new AppError(msg, 400, 'BAD_REQUEST'),

  // 401
  UNAUTHORIZED: (msg = 'Unauthorized — please log in') => new AppError(msg, 401, 'UNAUTHORIZED'),
  ...
  // 500
  INTERNAL: (msg = 'Internal server error') => new AppError(msg, 500, 'INTERNAL_SERVER_ERROR'),
};
